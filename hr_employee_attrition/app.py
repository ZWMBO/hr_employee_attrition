...
tpot_data = pd.read_csv('https://raw.githubusercontent.com/ZWMBO/hr_employee_attrition/master/hr_employee_attrition/prepared_data.csv')
features = tpot_data.drop('target', axis=1)
training_features, testing_features, training_target, testing_target = \
            train_test_split(features, tpot_data['target'], random_state=None)

# Average CV score on the training set was: -1.8674835901965718
exported_pipeline = LinearSVR(C=5.0, dual=True, epsilon=0.0001, loss="epsilon_insensitive", tol=1e-05)
...
######################
# User defined values
title = 'hr_employee_attrition'
encoder_location = 'https://github.com/ZWMBO/hr_employee_attrition/blob/master/hr_employee_attrition/encoder.pkl?raw=true'
